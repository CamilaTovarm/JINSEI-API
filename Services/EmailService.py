...
class EmailService:
    ...
    def send_consent_alert_email(self, consent_data, contact_data):
        """
        Envía un correo de alerta al equipo de profesionales cuando se crea un consentimiento.
        
        Args:
            consent_data: dict con información del consentimiento
                {
                    'ConsentId': int,
                    'FullName': str,
                    'DocumentNumber': str,
            ...
            contact_data: dict con información de contacto
                {
                    'email': str,
                    'phone': str
                }
    ...
    def _create_consent_alert_html(self, consent_data, contact_data):
        """
        Crea el cuerpo del correo en HTML con el formato de alerta profesional.
        
        Args:
            consent_data: Información del consentimiento
            ...
            <div class="container">
                ...
                <div class="content">
                    <div class="alert-message">
                        <p>
                            <strong>⚠️ Atención Inmediata Requerida</strong><br>
                    ...
                    <div class="info-section" style="margin-top: 25px;">
                        ...
                        <ul style="color: #333; line-height: 1.8;">
                            <li>Contactar al paciente dentro de las próximas <strong>2 horas</strong></li>
                            <li>Realizar evaluación inicial del riesgo</li>
                            <li>Determinar necesidad de intervención inmediata</li>
                            <li>Documentar toda comunicación en el sistema</li>
                ...
                <div class="footer">
                    <p><strong>Sistema de Alerta Temprana - Plataforma Jinsei</strong></p>
    ...
    def send_test_email(self, recipient_email):
        ...
        Args:
            recipient_email: Correo destinatario de la prueba
